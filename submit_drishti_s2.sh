...
# Submit: sbatch /users/k23123868/edward/spfilm/submit_drishti_s2.sh
...
cd "$CODE_ROOT"
echo "[$(date -u +%FT%TZ)] starting drishti_s2 on $(hostname) (job $SLURM_JOB_ID)"
...
echo "[$(date -u +%FT%TZ)] drishti_s2 finished"
