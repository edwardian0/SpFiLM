...
# Smoke: sbatch --time=0-00:20:00 /users/k23123868/edward/spfilm/submit_rimone_s2.sh --smoke
...
CONFIG="$CODE_ROOT/configs/stage2_rimone_create.json"
OUT_DIR="$CODE_ROOT/artifacts/runs/rim-one_s2_${SLURM_JOB_ID}"
...
echo "[$(date -u +%FT%TZ)] rimone_s2 finished"
